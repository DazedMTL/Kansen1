...
[if exp="kag.bookMarkProtectedStates[tf.save_lock_num+sf.saveload_now_page*20]"]
	; 真ならチェックマーク付きのチェックボックスに置き換え ＋5ってページボタンの数かなぁ？
...
;-----------------------------------------------------------
*save
;この処理がダイアログオン時のここでしかしてないのでまずかった。
;かつvoidならってなんで必要なんだろ？　データあったらオフになっちゃわね？
;その時はここじゃなくて上書きのほうにいくからいいのか
;sf.save_slot0 は最後にクリックした場所が0かどうかで合ってる？　0にデータがあるかどうかには使われてないよね？ 2018/02/05
